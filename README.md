...
### 🐴 Galloping Horse 2026 (galloping_horse_2026.py)
...
### 🌸 Geometric Mandala (geometric_mandala.py)
...
```bash
python <artwork_name>.py
```

The turtle graphics window will open and render the artwork. Close the window when finished viewing.
